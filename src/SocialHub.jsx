          ...
          {mainTab==='wizard'&&(()=>{
            ...
            const Step1=()=>(
              <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:12,padding:20}}>
                ...
                <label style={labelStyle}>Post content</label>
                <textarea defaultValue={wizardContent} onInput={e=>setWizardContent(e.target.value)} rows={8} style={{...inputStyle,fontSize:14,lineHeight:1.6,marginBottom:4}} placeholder={`Share something that reflects your philosophy…\n\n"Be Good. Do Good. Do Well."`}/>
            ...
            return(
              <div>
                <StepBar/>
                {wizardStep===1&&<Step1/>} rows={8} style={{...inputStyle,fontSize:14,lineHeight:1.6,marginBottom:4}} placeholder={"Share something that reflects your philosophy…
