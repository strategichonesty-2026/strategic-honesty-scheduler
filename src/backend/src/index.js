...
app.use(cors({ origin: (origin, cb) => (!origin || allowedOrigins.includes(origin) || devOrigins.includes(origin) ? cb(null, true) : cb(new Error("CORS blocked"))), credentials: true }));
